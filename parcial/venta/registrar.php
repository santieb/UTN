...
<body>
  ...
  <?php
    ...
    if(isset($_POST['enviar'])) {
      ...
      $sql2 = ""UPDATE inmueble SET estado = 'comprado' where id=$inmueble venta (comprador, inmueble, precio, fecha, comision) values ('$comprador', '$inmueble', '$precioventa', '$fecha', '$comision')";
